"""Stack-aware `doctor` for awrecurse.
...
interesting failures live BETWEEN them. "awrecurse is installed" is not the useful
fact -- "awrecurse is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awrecurse'
FAMILY = ['awask', 'awavatar', 'awbac', 'awbrain', 'awbrowse', 'awclassify', 'awdecide', 'awdelphi', 'awdit', 'awembed', 'awevolve', 'awfind', 'awflow', 'awfocus', 'awgit', 'awgraph', 'awgym', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awpool', 'awpredict', 'awprism', 'awprove', 'awreason', 'awrecover', 'awrelay', 'awrena', 'awrepl', 'awreport', 'awresearch', 'awrise', 'awrouter', 'awrtifact', 'awrun', 'awscreen', 'awseal', 'awsettings', 'awshare', 'awsprite', 'awstorage', 'awswarm', 'awtax', 'awtoll', 'awtunnel', 'awvision', 'awvoice', 'awwall', 'gawbbonet']
PAIRS_WITH = ['awembed', 'awfind', 'awm', 'awreason']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWRECURSE_TOKEN', 'AWRECURSE_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrecurse needs at runtime, and a
